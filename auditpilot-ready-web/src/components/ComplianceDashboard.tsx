        ...
        <div className="bg-gray-900 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <Card className="p-6 bg-gray-900 text-white">
              ...
              <div className="mb-4">
                <span className="text-sm text-gray-400">Parent Recoved</span>
              </div>
            ...
            <Card className="p-6 bg-gray-900 text-white">
              ...
              <div className="mb-4">
                <span className="text-sm text-gray-400">OSHA</span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm text-gray-400">TSCA first Score</span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm text-gray-400">SSA  Redist Score</span>
                  </div>
            ...
            <Card className="p-6 bg-gray-900 text-white">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <span className="text-sm text-gray-400">TSH%</span>
                ...
                <div className="flex items-center gap-2 mt-4">
                  <span className="text-sm text-gray-400">TAH%</span>
